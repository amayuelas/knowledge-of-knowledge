...
|:-------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------:|
| Things we are aware of and understand  e.g. _What’s the boiling temperature of water? |    Things we are aware of but do not understand e.g _How many planets are there in the universe?_    |
